...
ITERATIONS = 15 #number of times to run through the data
...
data_size =  9 #number of features SHOULDN'T BE A CONSTANT
...
with tf.Session() as sess:
    ...
    for epoch in range(ITERATIONS):
        ...
        for i in range(total_batch):
            ...
            sess.run([optimizer, cost], feed_dict={x: features,
                                                          y_: labels})
